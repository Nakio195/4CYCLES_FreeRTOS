...
void MX_SPI6_Init(void)
{
  ...
  hspi6.Init.MasterSSIdleness = SPI_MASTER_SS_IDLENESS_10CYCLE;
  hspi6.Init.MasterInterDataIdleness = SPI_MASTER_INTERDATA_IDLENESS_10CYCLE;
